...
- required_action: EXACTLY one of [coding_correction, clinical_documentation, appeal, no_action_required]
  ...
  - no_action_required: correctly adjudicated, e.g. genuine patient responsibility or a contractual write-off
...
2. Identify whether resolution requires a coding correction, clinical documentation, or an appeal.
