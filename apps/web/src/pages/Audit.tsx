...
type AuditStats = { total_entries?: number; recent_24h?: number }
type AuditActor = { actor: string; entry_count: number }
...
export default function Audit() {
  ...
  const parsedUsername = (details: unknown): string | null => {
    try {
  ...
  const OUTCOME_TONES: Record<'ok' | 'blocked' | 'warn' | 'error', ToneStyle> = {
                        ...
                        <tr>
                          ...
                          <td>
                            <span style={{
                              ...
                              color: (l.action && actionColors[l.action]) || 'var(--text-muted)',
